...
* Prerequisites:
    * PowerShell: Download [this PowerShell script](./scripts/update_date_modified.ps1) and place it as `%SystemDrive%\Program Files\Nilesoft Shell\scripts\update_date_modified.ps1`.
* Shell Code:
```
